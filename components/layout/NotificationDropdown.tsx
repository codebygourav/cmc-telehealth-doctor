    ...
    <DropdownMenu open={open} onOpenChange={handleOpenChange}>
      ...
      >
        <div className="flex flex-col max-h-[550px] bg-background">
          ...
          {showPushBanner && (
            <div className="relative flex items-center justify-between px-4 py-3 bg-slate-100/80 border-b border-border/40 gap-3">
                ...
                <span className="text-[11px] text-slate-600 font-medium leading-tight mt-0.5">
                  {permission === "denied"
                    ...
                    : subscription
                      ...
                      : "Enable instant alerts for new activity"}
                </span>
              </div>
              <div className="flex items-center gap-2">
                <Button
                  ...
                  className="h-8 text-xs px-3 rounded-lg font-bold shadow-xs shrink-0"
